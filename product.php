	...
	<div id="content">
		...
		<div id="mainFrame">
			...
			<div id="product_index">
				...
				<div>
					<a  href="img/product/handfoot2.jpg" target="blank">
				...
				<h3>Hand Only</h3>
				<div>
					<a  href="img/product/hand1.jpg"  target="blank">
				...
				<h3>Foot Only</h3>
				<div>
					<a  href="img/product/foot1.jpg" target="blank">
						<img src="img/product/foot1.jpg" alt="HappyOlina Hand and Foot Sculpture" />
					</a>
					<p>Foot only</p>
				</div>
				<div>
					<a  href="img/product/foot2.jpg"  target="blank">
				...
				<div>
					<a href="img/product/handsfoots2.jpg" target="blank">
						<img src="img/product/handsfoots2.jpg" alt="HappyOlina Hand and Foot Sculpture" />
					</a>
					<p>2 Hands and 2 Feet</p>
				</div>    
				<div>
					<a href="img/product/handsfoots3.jpg" target="blank">
				...
				<div>
					<a href="img/product/handsfoots7.jpg" target="blank">
						<img src="img/product/handsfoots7.jpg" alt="HappyOlina Hand and Foot Sculpture" />
					</a>
					<p>2 Hands and 2 Feet</p>
				</div>  
				<div>
					<a href="img/product/handsfoots8.jpg" target="blank">
